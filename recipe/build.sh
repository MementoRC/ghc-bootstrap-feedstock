...
update_settings() {
  if [[ "${target_platform}" == "osx-"* ]]; then
    ...
    clang_linking="${clang_linking} -Wl,--rpath,\\\$topdir/../../../../x86_64-conda-linux-gnu/sysroot/lib64"
    clang_linking="${clang_linking} -Wl,--rpath,\\\$topdir/../../../../x86_64-conda-linux-gnu/sysroot/usr/lib64"
    clang_linking="${clang_linking} -Wl,--rpath,\\\$topdir/../../../../x86_64-conda-linux-gnu/lib"
    clang_linking="${clang_linking} -Wl,--rpath,\\\$topdir/../../../../lib"
    clang_linking="${clang_linking} -Wl,--rpath-link,\\\$topdir/../../../../x86_64-conda-linux-gnu/sysroot/lib64"
    clang_linking="${clang_linking} -Wl,--rpath-link,\\\$topdir/../../../../x86_64-conda-linux-gnu/sysroot/usr/lib64"
    clang_linking="${clang_linking} -Wl,--rpath-link,\\\$topdir/../../../../x86_64-conda-linux-gnu/lib"
    clang_linking="${clang_linking} -Wl,--rpath-link,\\\$topdir/../../../../lib"
    ...
    ld_linking="${ld_linking} --rpath \\\$topdir/../../../../x86_64-conda-linux-gnu/sysroot/lib64"
    ld_linking="${ld_linking} --rpath \\\$topdir/../../../../x86_64-conda-linux-gnu/sysroot/usr/lib64"
    ld_linking="${ld_linking} --rpath \\\$topdir/../../../../x86_64-conda-linux-gnu/lib"
    ld_linking="${ld_linking} --rpath \\\$topdir/../../../../lib"
    ld_linking="${ld_linking} --dynamic-linker \\\$topdir/../../../../x86_64-conda-linux-gnu/sysroot/lib64/ld-2.17.so"
    ld_linking="${ld_linking} --disable-new-dtags"
